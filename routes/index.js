...
var genericschedulesSaxStream = require("sax").createStream(true);
...
var genericSchedulesParser = require('../parsers/generic_schedules')(genericschedulesSaxStream, outputDirectoryPrefix, router.io);
